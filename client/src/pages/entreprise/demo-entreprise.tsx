    ...
    <section id="about" className="py-24 bg-gradient-to-br from-gray-50 to-blue-50/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <RevealAnimation>
            <h2 className="text-3xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-gray-900 via-indigo-600 to-gray-800 bg-clip-text text-transparent">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <RevealAnimation delay={0.1}>
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200/50 hover:border-indigo-500/30 group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Nos développeurs, designers et product managers jouent ensemble dans la communauté Rayo générale, apportant l'esprit tech sur le terrain.
              </p>
            </div>
          </RevealAnimation>
          ...
          <RevealAnimation delay={0.3}>
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200/50 hover:border-orange-500/30 group">
              ...
              <p className="text-gray-600 leading-relaxed">
                Pas de ségrégation ! Nos employés participent aux tournois généraux de Casablanca, représentant fièrement leur entreprise tech.
              </p>
            </div>
          </RevealAnimation>
        </div>
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <RevealAnimation>
          ...
          <p className="text-xl max-w-3xl mx-auto mb-10 opacity-90">
            Inspirez-vous de notre approche : nos employés tech participent aux matchs généraux Rayo Casablanca, créant un pont unique entre innovation et sport
          </p>
...
const DemoEntreprisePage = () => {
  ...
  return (
    <CompanyLayout companyCode="demo-entreprise">
      <main className="overflow-hidden">
        <CompanyHeroSection 
          companyCode="demo-entreprise" 
        ...
        <CompanyAboutSection companyCode="demo-entreprise" />
...
export default DemoEntreprisePage;