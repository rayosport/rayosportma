      ...
      <div className="fixed inset-0 bg-jetblack flex flex-col items-center justify-center z-50">
        ...
        <div className="relative w-[164px] h-[164px] mb-4">
          <svg viewBox="0 0 164 164" className="w-full h-full">
            <defs>
              <radialGradient id="dialBgPaddel" cx="50%" cy="50%">
                <stop offset="0%" stopColor="#0f0f0f" />
                <stop offset="100%" stopColor="#0b0b0b" />
              </radialGradient>
            </defs>
            <circle cx="82" cy="88" r="64" fill="url(#dialBgPaddel)" stroke="#1f2937" strokeWidth="2" />
            ...
            <RevealAnimation>
              <div className="max-w-2xl mx-auto text-center">
                ...
                <button 
                  ...
                  onClick={() => {
                    trackEvent('voir_football_click', 'navigation', 'padel_page');
