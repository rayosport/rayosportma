...
// WhatsApp Modal pour université - Communauté unifiée
const UniversityWhatsAppModal = ({ isOpen, onClose, university }: { 
  isOpen: boolean; 
  onClose: () => void; 
  university: any;
}) => {
  const handleJoinClick = () => {
    trackEvent('whatsapp_join_university', 'user_engagement', university.shortName);
      ...
      <DialogContent className="w-[95vw] max-w-lg mx-auto bg-gradient-to-br from-white to-gray-50 border-none shadow-2xl rounded-2xl">
        <DialogHeader>
          <DialogTitle className="text-center text-xl md:text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent mb-2">
            Rejoindre {university.shortName} Rayo
          </DialogTitle>
        </DialogHeader>
        <div className="p-6 text-center">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-3">
            Communauté {university.shortName}
          </h3>
          
          <p className="text-gray-600 mb-8 leading-relaxed">
            Rejoignez la communauté Rayo Sport de l'Université Mohammed VI des Sciences de la Santé. 
            Tous les étudiants sont les bienvenus pour participer aux matchs et tournois.
          </p>
...
const UniversityHeroSection = ({ universityCode, onJoinClick }: UniversityHeroSectionProps) => {
  ...
  const handleJoinClick = () => {
    ...
    trackEvent('university_join_click', 'user_engagement', university.shortName);
  };

  return (
    <>
      <section id="hero" className="relative min-h-screen flex items-center bg-jetblack text-white overflow-hidden">
        {/* Background avec thème médical */}
        <div 
          className="absolute inset-0 z-0"
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1559757148-5c350d0d3c56?ixlib=rb-4.0.3&auto=format&fit=crop&w=2071&q=80')`,
        ...
        <div className="container mx-auto px-4 relative z-10">
          <RevealAnimation>
            ...
            <div className="text-center mb-8">
              ...
              <h3 className="text-lg md:text-xl text-blue-300 font-medium mb-2">Partenariat officiel</h3>
            ...
            <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-6 mb-8 border border-white/10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8 max-w-3xl mx-auto">
                <div className="text-center bg-white/10 rounded-xl p-4 backdrop-blur-sm border border-white/10">
                  <div className="text-2xl font-bold text-blue-300">{university.totalStudents}</div>
                  <div className="text-sm opacity-80">Étudiants</div>
                </div>
                <div className="text-center bg-white/10 rounded-xl p-4 backdrop-blur-sm border border-white/10">
                  <div className="text-2xl font-bold text-yellow-300">{university.sportsPrograms.length}</div>
                  <div className="text-sm opacity-80">Programmes</div>
                </div>
                <div className="text-center bg-white/10 rounded-xl p-4 backdrop-blur-sm border border-white/10">
                  <div className="text-2xl font-bold text-green-300">{university.established}</div>
                  <div className="text-sm opacity-80">Partenariat</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4 max-w-md mx-auto">
              ...
              >
                ...
                <div className="relative z-10 flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <div className="text-sm font-semibold">Rejoindre {university.shortName} Rayo</div>
                    <div className="text-xs opacity-90">Communauté étudiante</div>
                  </div>
                </div>
              </button>
              ...
              <button 
                ...
                onClick={() => {
                  trackEvent('view_university_matches_click', 'navigation', university.shortName);
              ...
              >
                ...
                <div className="relative z-10 flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <div className="text-sm font-semibold">Matchs {university.shortName}</div>
                    <div className="text-xs opacity-90">Inter-filières & promotions</div>
                  </div>
                </div>
              </button>
            </div>
      ...
      {/* Modal WhatsApp spécifique à l'université */}
      <UniversityWhatsAppModal 
